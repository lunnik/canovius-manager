package com.lionsquare.canisovismanager.helper;
...
/**
 * Created by archivaldo on 18/12/15.
 */
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "canovius_manager";
   ...
   // private static final String KEY_NAME = "name";
     ...
     * */
    public void addUser( String email,  String pass,String idUser,Boolean session) {
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("session", cursor.getString(4));
        }
        cursor.close();
        db.close();
        // return user
